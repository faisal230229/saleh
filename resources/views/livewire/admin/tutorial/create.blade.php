            ...
            <div class="box-body">
                <form wire:submit.prevent="store">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" wire:model="featured_image" required dir="rtl">
                            @if($featured_image)
                                <span>
                                <img width="80" src="{{ $featured_image->temporaryUrl() }}">
                            </span>
                            @endif
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" wire:model="secondary_image" required dir="rtl">
                            @if($secondary_image)
                                <span>
                                <img width="80" src="{{ $secondary_image->temporaryUrl() }}">
                            </span>
                            @endif
                        </div>
